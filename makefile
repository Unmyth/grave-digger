...
lifter : src/heap.fasl src/map.fasl src/simple-map.fasl
	sbcl --eval '(progn (load "src/heap.fasl") (load "src/map.fasl") (load "src/simple-map.fasl") (sb-ext:save-lisp-and-die "lifter" :executable t :toplevel (quote test) :purify t))'
